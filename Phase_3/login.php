...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ( !empty($enteredEmail) && !empty($enteredPassword) )   { 
        ...
        $query = try_login_as_user($enteredEmail);
        ...
        if (!empty($result) && ($count > 0) ) {
            ...
            if (password_verify($enteredPassword, $storedHash) ) {
                ...
                header(REFRESH_TIME . 'url=index.php');		//to view the password hashes and login success/failure
            ...
            <div class="text_box">
                ...
                <form action="login.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="login_form_row">
                        ...
                        <input type="text" name="email" value="roland" class="login_input"/>
                    </div>
                    <div class="login_form_row">
                        <label class="login_label">Password:</label>
                        <input type="password" name="password" value="roland" class="login_input"/>
                    </div>
